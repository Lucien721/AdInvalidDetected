 ...
 *
 */
public class Utils extends com.ibm.zrl.idmx.utils.Utils{
     ...
     * @return BigInteger encoding the date: <tt>date - 1.1.1980</tt>.
     */
    public static BigInteger encode(final String date,
        ...
        try {
            referenceDate = parseDate(dataType, "1800/01/01");
