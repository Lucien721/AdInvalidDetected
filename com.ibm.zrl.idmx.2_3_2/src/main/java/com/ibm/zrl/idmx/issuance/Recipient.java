...
public class Recipient {
    ...
    public Recipient(final IssuanceSpec issuanceSpec,
            final BigInteger pseudonym, final String pseudonymName,
    ...
    public Recipient(final IssuanceSpec issuanceSpec,
        ...
        this(issuanceSpec, null, null, null, masterSecret, theValues);
    }
    ...
    private BigInteger compute_C(final Vector<AttributeStructure> attStructs,
        ...
        return Utils.computeFSChallenge(sp, spec.getContext(), leftHandSide,
                attStructs, values, nym, theDomNym, capUTilde, commitments,
     ...
     */
    public final Message round1(final BigInteger theNonce1) {

        // nonce from Issuer
        assert (theNonce1 != null);
        ...
        issuanceProtocolValues.put(IssuanceProtocolValues.nonce_recipient, n2);
    ...
    public final Credential round3(final Message msg) {
        ...
        // TODO (pbi) do we need to check any values set by the issuer?

        // Now other standard checks
        ...
        Credential cred = new Credential(spec.getCredStructureLocation(), capA,
                e, v, values, masterSecret);
