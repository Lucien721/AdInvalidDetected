...
public class Prover {
    ...
    private void proveCL(final Credential cred, final CLPredicate pred) {
        if (!cred.getCredStructLocation().equals(pred.getCredStructLocation())) {
        ...
        // the master secret easily seperable)
    ...
    private void proveCL(final CLPredicate pred, final Credential cred,
        ...
        while (attributes.hasNext()) {
            ...
            if (!sValues.containsKey(identifier.getName())) {
                BigInteger s;
                if (identifier.isRevealed()) {
                    // instead of an s-value we set the attribute value as
                    // s-value for the revealed attributes
                    s = att.getValue();
                } else {
                    // mTilde_i := identifier.getRandom()
                    // m_i := att.getValue()
