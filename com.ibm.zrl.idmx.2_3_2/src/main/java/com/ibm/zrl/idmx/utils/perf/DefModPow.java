 ...
 */
package com.ibm.zrl.idmx.utils.perf;
...
public class DefModPow implements ModPow {
     ...
     * (non-Javadoc)
     * 
     * @see com.ibm.zrl.idmx.utils.perf.ModPow#getBase()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ibm.zrl.idmx.utils.perf.ModPow#getMaxExpWidth()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ibm.zrl.idmx.utils.perf.ModPow#getModulus()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.ibm.zrl.idmx.utils.perf.ModPow#modPow(java.math.BigInteger,
