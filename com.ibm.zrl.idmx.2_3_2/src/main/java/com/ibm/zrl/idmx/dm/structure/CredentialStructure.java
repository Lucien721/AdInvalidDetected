 ...
 */
package com.ibm.zrl.idmx.dm.structure;
...
public class CredentialStructure {
    ...
    /** Issuer public key. */
    private final URI issuerPublicKey;
    ...
    /**
     * @return Public key used for this credential structure.
     */
