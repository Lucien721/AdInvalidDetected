...
public class Identifier {
     ...
     * the VERIFIER's side.
     */
    private URI credentialStructureLocation;
    ...
    public final AttributeStructure getAttStruct() {
        if (attr != null) {
            ...
            CredentialStructure credStruct = (CredentialStructure) StructureStore
                    .getInstance().get(credentialStructureLocation);
    ...
    public final void setAttributeName(final String credStructLocation,
            final String attName) {
        try {
            credentialStructureLocation = new URI(credStructLocation);
